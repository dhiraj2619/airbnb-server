...
const { addProperty, getAllProperties, getHostProperties, updateProperty } = require('../controllers/property.controller');
...
propertyRouter.put('/update/:id',authenticate,isRoleHost,upload.fields([
    {
        name: 'images',
        maxCount: 5
    }
